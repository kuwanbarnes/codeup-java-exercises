...
public class Instructor {
    ...
    // making this static, so that when other instructors are created,
    // they'll all be able to access this value to increment it

    public Instructor(String first, String last) {
        this.firstName = first;
        this.lastName = last;
        this.brainWaveFrequency = 0; // just a default!
        numInstructors++; // we have another instructor now,
        // add to the count
